...
function toggleBtns(...buttons) {
    buttons.forEach((button)=>button.disabled ? button.disabled = false : button.disabled = true);
}
...
function playMusic() {
    const audio = new Audio("/Psychedelic Universe Original Mix ! Psychedelic Universe.mp3");
    audio.play();
}
refs.startBtn.addEventListener("click", playMusic);

},{"../css/common.css":"97fCK"}],"97fCK":[function() {},{}]},["eFy9v","cYUEh"], "cYUEh", "parcelRequired7c6")

...
const flatPicker = (0, _flatpickrDefault.default)("input#datetime-picker", {
    enableTime: true,
    time_24hr: true,
...
function startCountdown() {
    ...
    const intervalId = setInterval(()=>{
        ...
        if (timeDelta < 1000) {
            ...
            (0, _notiflixNotifyAio.Notify).failure("time is out", {
                timeout: 2000,
...
function checkFutureDate(userTime) {
    ...
    const timeDelta = userChosenTime.getTime() - currentTime.getTime();
    if (timeDelta < 0) {
        (0, _notiflixNotifyAio.Notify).failure("Please choose a date in future", {
            timeout: 2000,
            showOnlyTheLastOne: true,
            position: "center-top"
        });
